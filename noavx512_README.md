...
<p align="center">
  <a href="https://pypi.org/project/vllm-cpu/">
    <img src="https://img.shields.io/pypi/v/vllm-cpu?style=for-the-badge&logo=pypi&logoColor=white&labelColor=2b3137&color=3775a9" alt="PyPI Version">
  </a>
  <a href="https://pypi.org/project/vllm-cpu/">
    <img src="https://img.shields.io/pypi/dm/vllm-cpu?style=for-the-badge&logo=pypi&logoColor=white&labelColor=2b3137&color=9c27b0" alt="PyPI Downloads">
  </a>
...
vLLM is a fast and easy-to-use library for LLM inference and serving. <b>This PyPl package has NO support for AVX512/VNNI/AVX512BF16/AMXBF16.</b> CPU inference will not have any instruction set acceleration. Only RAW CPU power will be used. <b>This package should be used for inference on ARM64 CPUs</b>
...
- **For versions 0.8.5–0.12.0, use `.post2` releases** (e.g., `pip install vllm-cpu==0.12.0.post2`) — includes critical CPU platform detection fix
